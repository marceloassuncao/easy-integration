...
if (!class_exists('easyInteg')):
    class easyInteg
    {
        ...
        public function integ_enqueue_scripts()
        {
            wp_enqueue_script(
                'integ-script',
                INTEG_ASSETS_URL . 'js/easy-integ-frontend.js'
            );

            wp_enqueue_style(
                'integ-style',
                INTEG_ASSETS_URL . 'css/easy-integ-frontend.css'
            );
        }
        ...
        public function integ_admin_enqueue_scripts()
        {
            wp_enqueue_script(
                'integ-admin-script',
                INTEG_ASSETS_URL . 'js/easy-integ-backend.js'
            );

            wp_enqueue_style(
                'integ-admin-style',
                INTEG_ASSETS_URL . 'css/easy-integ-backend.css'
            );
        }
